...
Use the **Content Database** Godot dock to search, create, duplicate, edit, validate, and remove content. It supports items, buildings, resource nodes, recipes, workstations, and skills. See [the editor guide](docs/CONTENT_DATABASE.md) for the workflow and extension points.
